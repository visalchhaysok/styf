...
export default function AccountNavbar({ onMenuClick }: DashboardNavbarProps) {
    ...
    return (
        <header className="flex items-center justify-between border-b border-[#e5ded4] bg-[#f8f6f2]/90 px-5 py-5 backdrop-blur-sm md:px-10 lg:px-12">
            <button
                // className="rounded-lg border border-[#e5ded4] p-2"
            ...
            >
                <Menu size={18} strokeWidth={1.5} className="bg-white" />
                <span>Menu</span>
            </button>

            <div className="hidden items-center gap-3 text-sm text-[#8c8378] md:flex ml-2">
                <span>Account</span>
                <span>/</span>
